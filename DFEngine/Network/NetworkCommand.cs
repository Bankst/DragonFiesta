namespace DFEngine.Network
{
	...
	/// </summary>
	public enum NetworkCommand : ushort
	{
		...
		NC_LOCAL_REGISTERZONE_REQ = 0xD803,
		NC_LOCAL_REGISTERZONE_ACK = 0xD804,
		NC_LOCAL_REGISTERZONE_CMD = 0xD805,
		NC_LOCAL_REGISTEROTHERZONE_CMD = 0xD806,
		NC_LOCAL_ADDTRANSFER_CMD = 0xD807,
		NC_LOCAL_ENDLINK_REQ = 0xD808,
		NC_LOCAL_UES_FRIEND_POINT_REQ = 0xD809,
		NC_LOCAL_UES_FRIEND_POINT_ACK = 0xD80A,
		NC_LOCAL_CHAR_SUB_MONEY_CMD = 0xD80B,
		NC_LOCAL_GUILD_MEMBER_CHANGE_CMD = 0xD80C,
		NC_LOCAL_PARTY_CREATE_CMD = 0xD80D,
		NC_LOCAL_PARTY_MEMBER_JOIN_CMD = 0xD80E,
		NC_LOCAL_PARTY_MEMBER_LEAVE_CMD = 0xD80F,
		NC_LOCAL_PLAYERFIND_REQ = 0xD810,
		NC_LOCAL_PLAYERFIND_ACK = 0xD811,
		NC_LOCAL_PLAYERSUMMON_REQ = 0xD812,
		NC_LOCAL_PLAYERSUMMON_ACK = 0xD813,
		NC_LOCAL_PARTY_CHANGEMASTER_CMD = 0xD814,
		NC_LOCAL_CHAR_LEVELUP_CMD = 0xD815,
		NC_LOCAL_MAP_DECSUB_CMD = 0xD816,
		NC_LOCAL_MAP_INCSUB_CMD = 0xD817,
		NC_LOCAL_MAP_LINKINSTANCE_CMD = 0xD818,
		NC_LOCAL_MAP_LINK_REQ = 0xD819,
		NC_LOCAL_MAP_LINK_ACK = 0xD81A,
		NC_LOCAL_GUILD_STORAGE_CELLCHANGE_CMD = 0xD81B,
		NC_LOCAL_GUILD_STORAGE_NOTIFY_WITHDRAW = 0xD81C,
		NC_LOCAL_GUILD_STORAGE_NOTIFY_DEPOSIT = 0xD81D,
		NC_LOCAL_CHAR_BLOCKDATA_ERR = 0xD81E,
		NC_LOCAL_HOLY_PROMISE_REWARD_CMD = 0xD81F,
		NC_LOCAL_HOLY_PROMISE_ITEM_BUY_CMD = 0xD820,
