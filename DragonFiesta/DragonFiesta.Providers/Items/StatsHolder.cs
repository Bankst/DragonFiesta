	...
	public sealed class StatsHolder
	{
		...
		public static StatsHolder operator +(StatsHolder s1, StatsHolder s2)
		{
			var newStats = new StatsHolder
			{
				...
				WeaponDamage = new MinMax<int>(s1.WeaponDamage.Min + s2.WeaponDamage.Min, s1.WeaponDamage.Max + s2.WeaponDamage.Max),
				WeaponDefense = s1.WeaponDefense + s2.WeaponDefense,
				MagicDamage = new MinMax<int>(s1.MagicDamage.Min + s2.MagicDamage.Min, s1.MagicDamage.Max + s2.MagicDamage.Max),
				MagicDefense = s1.MagicDefense + s2.MagicDefense,
				BlockRate = s1.BlockRate + s2.BlockRate,
				CriticalRate = s1.CriticalRate + s2.CriticalRate,
				CriticalWeaponDamage = new MinMax<int>(s1.CriticalWeaponDamage.Min + s2.CriticalWeaponDamage.Min, s1.CriticalWeaponDamage.Max + s2.CriticalWeaponDamage.Max),
				CriticalMagicDamage = new MinMax<int>(s1.CriticalMagicDamage.Min + s2.CriticalMagicDamage.Min, s1.CriticalMagicDamage.Max + s2.CriticalMagicDamage.Max),
