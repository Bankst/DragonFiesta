...
{
    public sealed class Handler49Type : HandlerType
    {
        ...
        public const ushort NC_COLLECT_PEEPING_DB_REQ = 2;

        public const ushort NC_COLLECT_PEEPING_DB_COLLECT_ACK = 3;

        public const ushort NC_COLLECT_PEEPING_DB_COLLECT_BOOKMARK_ACK = 4;

        public const ushort NC_COLLECT_PEEPING_COLLECT_ACK = 5;
        ...
        public const ushort NC_COLLECT_REWARD_DB_REQ = 17;

        public const ushort NC_COLLECT_REWARD_DB_ACK = 18;

        public const ushort NC_COLLECT_REWARD_ACK = 19;

        public const ushort NC_COLLECT_CHARACTERDB_UP_GET_CARDCOUNT_CMD = 20;  
