namespace DragonFiesta.Networking.HandlerTypes
{
    public sealed class Handler26Type : HandlerType
    {
        ...
        public const ushort NC_BOOTH_SOMEONEOPEN_CMD = 3;
        ...
        public const ushort NC_BOOTH_ENTRY_REQ = 7;

        public const ushort NC_BOOTH_ENTRY_SELL_ACK = 8;

        public const ushort NC_BOOTH_ENTRY_BUY_ACK = 9;

        public const ushort NC_BOOTH_REFRESH_REQ = 10;

        public const ushort NC_BOOTH_REFRESH_SELL_ACK = 11;
        ...
        public const ushort NC_BOOTH_SEARCH_BOOTH_CLOSED_CMD = 23;         
