namespace DragonFiesta.Networking.HandlerTypes
{
    public sealed class Handler15Type : HandlerType
    {
        ...
        //NC
        public const ushort NC_MENU_SHOPOPENWEAPON_CMD = 3;

        public const ushort NC_MENU_SHOPOPENSKILL_CMD = 4;

        public const ushort NC_MENU_SHOPOPENITEM_CMD = 6;

        public const ushort NC_MENU_OPENSTORAGE_FAIL_CMD = 7;

        public const ushort NC_MENU_RANDOMOPTION_CMD = 14;

        public const ushort NC_MENU_SERVERMENU_CLOSE_CMD = 15;

        public const ushort NC_MENU_INDUNRANK_CMD = 16; 
